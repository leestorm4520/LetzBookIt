...
<body>
    ...
    <nav class="navbar navbar-inverse">
        ...
        $sql="SELECT * FROM Hotel_Rooms
              ...
              WHERE Hotel.name = 'HomeAway Inn' ";
              //This query will get all hotel room types associated with the HomeAway Inn
        ...
        if($result)
        {
            if(mysqli_num_rows($result) > 0)
            {
                echo "
                        <div>
                               <h2 style='color:white'> Welcome to the HomeAway Inn</h2>   
                            </div>
