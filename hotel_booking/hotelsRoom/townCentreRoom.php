...
<body>
    ...
    <nav class="navbar navbar-inverse">
        ...
        $sql="SELECT * FROM Hotel_Rooms
              ...
              WHERE Hotel.name = 'The Lofts at Town Center' ";
              //This query will get all hotel room types associated with the The lofts at Town Center
        ...
        if($result)
        {
            if(mysqli_num_rows($result) > 0)
            {
                echo "
                        <div>
                               <h2 style='color:white'> Welcome to The Lofts at Town Center</h2>   
                            </div>
