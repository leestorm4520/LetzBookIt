                    ...
                    echo "
                        <div>
                            ...
                            <div class='form-group'>
                             ...
                             <a href='TownCentre.php?room_size=".$row['room1']."'><button>QUEEN SIZE</button> </a>
                             <a href='TownCentre.php?room_size=".$row['room2']."'><button>STANDARD SIZE</button> </a>
                             <a href='TownCentre.php?room_size=".$row['room3']."'><button>KING SIZE</button> </a>
                            </div>
                        </div>
                         "; //echo end                                         
                }                                      
